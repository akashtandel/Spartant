	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="trainer_index.php" class="nav-link">Home</a></li>
				<li class="nav-item"><a href="tariner_member.php" class="nav-link">Members</a></li>
    	...
    	<div class="container">
    		<div class="row">
		          ...
		          <div class="heading-section mb-4">
		            ...
		            <h2 class="mb-1">Hello <span><?php echo "$t_name";?></span> Welcome to Spartant Crossfit Gym </h2>
		          </div>
