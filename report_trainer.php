        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center pt-5 mt-md-5">
			...
			<div>
				...
				<a href="report_trainer.php" ><font color="white"><u>Trainer</u></font></a>&nbsp;&nbsp;&nbsp;
	...
	<section class="ftco-section bg-light">
		...
		<div class="card-body">
              <table id="example1" border="1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$sqlq=mysqli_query($con,"select * from tbl_trainer");
				while($resq=mysqli_fetch_assoc($sqlq))
				{
					$t_id=$resq['t_id'];
					$t_name=$resq['t_name'];
					$t_email=$resq['t_email'];
					$t_image=$resq['t_image'];
					$t_mobile=$resq['t_mobile'];					
					$t_exp=$resq['t_exp'];					
				?>				
                <tr>
                  
                  <td align="center"><?php echo $t_id;?></td>
				  <td align="center"><image src="<?php echo $t_image;?>" height="100px" width="100px"></image></td>
				  <td align="center"><?php echo $t_name;?></td>
                  <td align="center"><?php echo $t_mobile;?></td>
                  <td align="center"><?php echo $t_email;?></td>
                  <td align="center"><?php echo $t_exp;?></td>
