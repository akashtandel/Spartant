        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center pt-5 mt-md-5">
			...
			<div>
				...
				<h4><p>
				<a href="report_user.php" ><font color="white"><u>Members</u></font></a>&nbsp;&nbsp;&nbsp;
				<a href="report_trainer.php" ><u>Trainer</u></a>&nbsp;&nbsp;&nbsp;
				<a href="report_payment.php" ><u>payment</u></a>&nbsp;&nbsp;&nbsp;
	...
	<section class="ftco-section bg-light">
		...
		<div class="card-body">
              <table id="example1" border="1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$sqlq=mysqli_query($con,"select * from tbl_member m,tbl_batch b where m.b_id=b.b_id ");
				while($resq=mysqli_fetch_assoc($sqlq))
				{
					$m_name=$resq['m_name'];
					$m_email=$resq['m_email'];
					$m_image=$resq['m_image'];
					$stime=$resq['stime'];
					$etime=$resq['etime'];
					$m_mobile=$resq['m_mobile'];
					$m_height=$resq['m_height'];
					$m_weight=$resq['m_weight'];
					$m_ttype=$resq['m_ttype'];
					$m_gender=$resq['m_gender'];
					$m_dob=$resq['m_dob'];
					$m_address=$resq['m_address'];
                ...
                <tr>
				  ...
				  <td><image src="<?php echo $m_image;?>" height="100px" width="100px"></image></td>
				  <td align="center"><?php echo $m_name;?></td>
				  <td align="center"><?php echo $stime."  to  ".$etime;?></td>
                  <td align="center"><?php echo $m_mobile;?></td>
                  <td align="center"><?php echo $m_email;?></td>
                  <td align="center"><?php echo $m_height."   /  ".$m_weight;?></td>
                  <td align="center"><?php echo $m_ttype;?></td>
                  <td align="center"><?php echo $m_gender;?></td>
                  <td align="center"><?php echo $m_dob;?></td>
                  <td align="center"><?php echo $m_address;?></td>
